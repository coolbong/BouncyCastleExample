...
public class PaddingTest {
    ...
    public void test_padding_001() {
        ...
        byte[] answer = {(byte)0x5A, (byte)0x5A, (byte)0x5A, (byte)0x5A, (byte)0x5A, 0x00, 0x00, 0x00 };
    ...
    public void test_padding_002() {
        byte[] answer = {(byte)0x5A, (byte)0x5A, (byte)0x5A, (byte)0x5A, (byte)0x5A, 0x03, 0x03, 0x03 };
        byte[] data = new byte[5];
        Arrays.fill(data, (byte)0x5A);
